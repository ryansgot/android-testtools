...
dependencies {
    ...
    implementation(mainDep(producer = "androidx", name = "multidex"))
    compileOnly(mainDep(producer = "androidx", name = "lifecycle-extensions"))

    implementation(testDep(producer = "androidx", name = "arch-testing"))
    implementation(testDep(producer = "androidx", name = "runner")) {
...
fsPublishingConfig {
    ...
    description = "Testing tools intended for Android"
...
bintray {
    ...
    pkg.apply {
        repo = "maven"
        name = project.name
        desc = "Testing tools intended for Android"
        ...
        setLabels("test", "android", "junit", "junit4", "multidex test runner")
        version.apply {
